...
Prisma Cloud supports the CIS OpenShift benchmark on OCP 4.6 and later. The Compliance ID for OpenShift starts with 300.
This is applicable to OpenShift Worker Nodes/Hosts.
